...
public class Property extends Compiler {
	...
	public void appendJava(StringBuilder sb, Global g, Global root)throws ParseException
	{
		...
		//if (Compiler.verbose){
			...
			sb.append("\r\nif (! queue.offer( \"[" + name + "]MOVED ON METHODCALL: \"+ _info +\" TO STATE::> \" + _string_"+name+"(_state_id_"+name+", 1))){");
			sb.append("\r\n System.out.println(\"SealFS Writing busy, log missed: \" + \"[" + name + "]MOVED ON METHODCALL: \"+ _info +\" TO STATE::> \" + _string_"+name+"(_state_id_"+name+", 1));}}");
		//}
		sb.append("\r\n}");
